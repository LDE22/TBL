...
@dso_cache = dso_local local_unnamed_addr global [826 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 656442152, ; hash 0x27208328, from name: aot-Dapper.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 774579943, ; hash 0x2e2b26e7, from name: libaot-Dapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 1024481359, ; hash 0x3d10584f, from name: libaot-TBL
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1041637556, ; hash 0x3e1620b4, from name: libaot-Dapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 1494165298, ; hash 0x590f2732, from name: aot-TBL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TBL.dll.so
		ptr null; void* handle (0x0)
	}, ; 280
	...
	%struct.DSOCacheEntry {
		i64 1558363701, ; hash 0x5ce2be35, from name: aot-TBL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TBL.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	...
	%struct.DSOCacheEntry {
		i64 1615572789, ; hash 0x604baf35, from name: aot-Dapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 293
	%struct.DSOCacheEntry {
		i64 1623946791, ; hash 0x60cb7627, from name: Dapper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2007445634, ; hash 0x77a73082, from name: Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2944453291, ; hash 0xaf80caab, from name: libaot-TBL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TBL.dll.so
		ptr null; void* handle (0x0)
	}, ; 561
	...
	%struct.DSOCacheEntry {
		i64 2957275192, ; hash 0xb0447038, from name: Dapper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Dapper.dll.so
		ptr null; void* handle (0x0)
	}, ; 567
	...
	%struct.DSOCacheEntry {
		i64 3112930463, ; hash 0xb98b8c9f, from name: aot-Npgsql.EntityFrameworkCore.PostgreSQL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		ptr null; void* handle (0x0)
	}, ; 602
	...
	%struct.DSOCacheEntry {
		i64 3233354242, ; hash 0xc0b91202, from name: TBL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TBL.dll.so
		ptr null; void* handle (0x0)
	}, ; 632
	...
	%struct.DSOCacheEntry {
		i64 3444996912, ; hash 0xcd567b30, from name: TBL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TBL.dll.so
		ptr null; void* handle (0x0)
	}, ; 664
	...
	%struct.DSOCacheEntry {
		i64 3490233047, ; hash 0xd008bad7, from name: aot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		ptr null; void* handle (0x0)
	}, ; 670
	...
	%struct.DSOCacheEntry {
		i64 3717170208, ; hash 0xdd8f8420, from name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		ptr null; void* handle (0x0)
	}, ; 720
	...
	%struct.DSOCacheEntry {
		i64 4101236366, ; hash 0xf473e68e, from name: Npgsql.EntityFrameworkCore.PostgreSQL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		ptr null; void* handle (0x0)
	}, ; 785
	...
	%struct.DSOCacheEntry {
		i64 4129202517, ; hash 0xf61ea155, from name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.38_name, ; name: libaot-Npgsql.EntityFrameworkCore.PostgreSQL.dll.so
		ptr null; void* handle (0x0)
	}, ; 796
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [167 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
